      ...
      <a-row>
        <a-col>
          ...
          <p class="item">
            ...
            <a-input-number style="width: 400px;" :min="0" :max="1000000" :step="0.0001" v-model="info.product_repertory" />
          </p>
          <p class="item">
          ...
          <p class="item">
            ...
            <a-input-number style="width: 400px;" :min="0" :max="1000000" :step="0.0001" v-model="info.unit_price_unit" />
          </p>
          <p class="item">
...
import { c_product } from "@/api/product.js";
export default {
  data() {
    return {
      visible: false,
  ...
  methods: {
    show() {
      ...
      this.info.product_size_long = 0;
      this.info.product_size_width = 0;
      this.info.product_size_height = 0;
      this.info.product_repertory = 0;
      this.info.unit_price = 0;
      this.info.unit_price_unit = 0;
    ...
    onSubmit() {
      ...
      c_product(this.handle_submit_data(this.submit_info))
        .then(res => {
          console.log(res);
          if (res.status) {
