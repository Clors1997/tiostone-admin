    ...
    <div class="new-pmaster-modal">
      <a-row>
        <a-col>
          ...
          <p class="item" v-if="!(info.discount_send > 0)">
          ...
          <p class="item">
            ...
            <a-input-number disabled style="width: 400px;" :min="0" :max="1000000" :step="0.01" v-model="info.discount_quantity" />
          </p>
          <p class="item">
            <span class="label required">Rate</span>
            <a-input-number :disabled="Number(info.discount_billed) > 0" style="width: 400px;" :min="0" :max="1000000" :step="0.01" v-model="info.discount_rate" />
          </p>
          <p class="item">
...
import { u_invoice_discount } from "@/api/invoice_discount.js";
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      u_invoice_discount(this.handle_submit_data(this.submit_info))
        .then(res => {
          console.log(res);
          if (res.status) {
